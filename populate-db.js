...
// async-ify the classic jsonfile.readFile method because I don't like callbacks, and I still want to do this thing in parallel with the database client connection :x
...
async function populateDB() {
    let fileData = null;
    let readFileData = async function() {fileData = await readJSON(FILE)};
    await readFileData() + await dbClient.connect();
